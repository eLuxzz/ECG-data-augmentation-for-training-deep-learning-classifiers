...
class ResidualUnit(object):
    ...
    def __init__(self, n_samples_out, n_filters_out, kernel_initializer='he_normal',
                 ...
                 postactivation_bn=False, activation_function='relu', l2_lambda = 0.001):
    ...
    def __call__(self, inputs):
        ...
        x = Conv1D(self.n_filters_out, self.kernel_size, padding='same',
                   use_bias=False, kernel_initializer=self.kernel_initializer, kernel_regularizer=l2(self.l2_lambda/10))(x)
...
def get_model(n_classes, dropout_keep_prob = 0.7, last_layer='sigmoid', l2_lambda = 0.001):
    ...
    x, y = ResidualUnit(64, 256, kernel_size=kernel_size,dropout_keep_prob=droupout_keep_prob,
                        kernel_initializer=kernel_initializer)([x, y])
    x, _ = ResidualUnit(16, 320, kernel_size=kernel_size,dropout_keep_prob=droupout_keep_prob,
                        kernel_initializer=kernel_initializer)([x, y])
    x = Flatten()(x)
    diagn = Dense(n_classes, activation=last_layer, kernel_initializer=kernel_initializer, kernel_regularizer=l2(l2_lambda))(x)
