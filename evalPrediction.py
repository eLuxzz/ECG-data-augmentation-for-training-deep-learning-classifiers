...
# %% Read datasets
# Get true values
y_true = pd.read_csv('data/PTB_XL_data/test_data.csv').values
# get y_score
y_score_best = np.load('dnn_predicts/base_predict.npy')
...
# mask = (y_score_best >= threshold).astype(int)
mask = y_score_best > 0.278
