...
def McNemarTest(): # Used for comparing different sources, eg DNN vs Cardio
    ...
    # Save results
    mcnemar.to_excel(f"{output_path}/tables/mcnemar.xlsx", float_format='%.3f')
    mcnemar.to_csv(f"{output_path}/tables/mcnemar.csv", float_format='%.3f')
def KappaScore(): # Used for comparing different sources, eg DNN vs Cardio
    ...
    # Save results
    kappa.to_excel(f"{output_path}/tables/kappa.xlsx", float_format='%.3f')
    kappa.to_csv(f"{output_path}/tables/kappa.csv", float_format='%.3f')
    ...
    kappas_annotators_and_DNN.to_excel(f"{output_path}/tables/kappas_annotators_and_DNN.xlsx", float_format='%.3f')
    kappas_annotators_and_DNN.to_csv(f"{output_path}/tables/kappas_annotators_and_DNN.csv", float_format='%.3f')

def AlternativeSplits(): # Used to compare different models.
